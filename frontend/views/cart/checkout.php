...
<div class="banner">
    ...
    <div class="w3l_banner_nav_right">
        ...
        <div class="privacy about">
            ...
            <?php if (isset($session['cart']) && count($session['cart'])): ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="invert-image"><a href="<?= \yii\helpers\Url::to(['product/view', 'id' => $id]) ?>">
                                    <?= \yii\helpers\Html::img("@web/products/{$item['img']}", ['alt' => $item['title'], 'height' => 50]) ?></a>
                            </td>
                            <td class="invert">
                                <div class="quantity">
            ...
            <div class="checkout-left">
                <div class="col-md-4 checkout-left-basket">
                    ...
                    <ul>
                        ...
                        <li><?= $item['title'] ?> <span>$<?= $item['price'] * $item['qty'] ?> </span></li>
                        <?php endforeach; ?>
                        <li>Total <span>$<?= $session['cart.total'] ?></span></li>
                    </ul>
                </div>
