...
<div class="products-breadcrumb">
    <div class="container">
        <ul>
            ...
            <li>
                <?php foreach ($crumbData as $idx => $crumb): ?>
                    <?php if ($idx == 0): ?>
                        <a><?= $crumb['title'] ?></a>
                    <?php else: ?>
                        <a href="<?= \yii\helpers\Url::to(['category/view', 'id' => $crumb['id']]) ?>"><?= $crumb['title'] ?></a>
                    <?php endif; ?>
                    <?php if ($idx < count($crumbData)-1): ?>
                        <span>&#10149;</span>
                    <?php endif; ?>
                <?php endforeach; ?>
            </li>
